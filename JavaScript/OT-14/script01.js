...
pessoa.fazerAniversario(); // 31 anos
...
pessoa.andar(100); // Caminhou 100 metros
...
console.log(pessoa.caminhouQuantosMetros); // 100 metros
...
pessoa.apresentacao = function() {
    var artigo = (this.sexo === "Feminino") ? "a" : "o";
    var pluralIdade = (this.idade === 1) ? "ano" : "anos";
    var pluralMetros = (this.caminhouQuantosMetros === 1) ? "metro" : "metros";

    return "Olá, eu sou " + artigo + " " + this.nomeCompleto() + ", tenho " + this.idade + " " + pluralIdade + ", minha altura é " + this.altura + "m, meu peso é " + this.peso + "Kg e, só hoje, eu já caminhei " + this.caminhouQuantosMetros + " " + pluralMetros + "!";
}

// Agora, apresente-se ;)

console.log(pessoa.apresentacao()); // Olá, eu sou o João Silva, tenho 33 anos, minha altura é 1.75m, meu peso é 70Kg e, só hoje, eu já caminhei 100 metros!